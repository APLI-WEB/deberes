...
public class DetallePedido implements Serializable {
    ...
    @JoinColumn(name = "codigo_pedido", referencedColumnName = "codigo_pedido", nullable = false, insertable = false, updatable = false)
    ...
    public String toString() {
        return "com.mycompany.bromeroo.DetallePedido[ detallePedidoPK=" + detallePedidoPK + " ]";
    }
