...
public class Pago implements Serializable {
    ...
    @JoinColumn(name = "codigo_cliente", referencedColumnName = "codigo_cliente", nullable = false, insertable = false, updatable = false)
    ...
    public String toString() {
        return "com.mycompany.bromeroo.Pago[ pagoPK=" + pagoPK + " ]";
    }
