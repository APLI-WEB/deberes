...
import com.mycompany.bromeroo.Pago;
...
public class PagoController implements Serializable {
    ...
    @EJB
    private com.mycompany.romerito.PagoFacade ejbFacade;
    ...
    public Pago getSelected() {
        if (current == null) {
            current = new Pago();
            current.setPagoPK(new com.mycompany.bromeroo.PagoPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            current.getPagoPK().setCodigoCliente(current.getCliente().getCodigoCliente());
    ...
    public Pago getPago(com.mycompany.bromeroo.PagoPK id) {
    ...
    public static class PagoControllerConverter implements Converter {
        ...
        com.mycompany.bromeroo.PagoPK getKey(String value) {
            com.mycompany.bromeroo.PagoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.bromeroo.PagoPK();
            key.setCodigoCliente(Integer.parseInt(values[0]));
            key.setIdTransaccion(values[1]);
            return key;
        }

        String getStringKey(com.mycompany.bromeroo.PagoPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getCodigoCliente());
            sb.append(SEPARATOR);
            sb.append(value.getIdTransaccion());
            return sb.toString();
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Pago) {
                Pago o = (Pago) object;
                return getStringKey(o.getPagoPK());
            } else {
