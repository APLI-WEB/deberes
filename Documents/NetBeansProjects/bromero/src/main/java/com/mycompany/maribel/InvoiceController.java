...
public class InvoiceController implements Serializable {
    ...
    @EJB
    private com.mycompany.maribel.InvoiceFacade ejbFacade;
    ...
    public static class InvoiceControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Invoice) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Invoice.class.getName());
            }
        }
